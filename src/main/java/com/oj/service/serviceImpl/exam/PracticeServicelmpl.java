...
public class PracticeServicelmpl implements PracticeService {
    ...
    public List<Map> getTargetProblemList(String stuId){
        ...
        List<Map<String, Object>> AllProList = mapper.getProblemList(); //获取公开的题目集
        ...
        AllProList.forEach(cell ->{
            ...
            int tNum = (int)(0.05*(100-Double.parseDouble(cell.get("proAcPercentage").toString())) );
            tNum = (tNum==0?1:tNum);
    ...
    public Map getSystemSimpleInf(String stuId){
        ...
        List AllProblemlist = mapper.getProblemList();
