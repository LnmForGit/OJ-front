    ...
    if(replyList.length>0){
     ...
     for(var i in replyList){
         ...
         Test+=' <li class="media">\n' +
             ...
             '                                       <i class="fa fa-thumbs-up">&nbsp&nbsp</i><a onclick="replyzan('+replyList[i].id+')">赞('+replyList[i].zannum+')</a></div>\n' +
             '                                </div>\n';
        ...
        data:JSON.stringify({
           ...
           for(var j in result){
               newtest+=' <div class="media">\n' +
                   ...
                   '<div class="small text-right">\n' +
                   '                                    <div><i class="fa fa-comments-o"> </i>' +
                   '<a class="reply_btn" onclick="reply_btn('+result[j].id+','+result[j].level+')">回复('+ result[j].sum+')&nbsp&nbsp</a>|\n' +
                   '                                        <i class="fa fa-thumbs-up">&nbsp&nbsp</i><a onclick="replyzan('+result[j].id+')">赞('+result[j].zannum+')</a></div>\n' +
                   '                                </div>'+
                   '                            </div>\n' +
                   '                        </div>\n';
           }
